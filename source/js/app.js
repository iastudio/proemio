...
$(function(){
  ...
  $('.topbar__search').on('click', '.topbar__searchbutton', function(e) {
    var $root = $('.topbar__search');
    if ( $root.hasClass('inactive') ) {
      $root.removeClass('inactive').addClass('active');
      $root.find('.topbar__input').focus();
    } else {
      $root.find('.topbar__form').submit();
      console.log($root.find('.topbar__form'));
    }
  });

  $('.topbar__search .topbar__closeform').on('click', function(e) {
    $('.topbar__search.active').removeClass('active').addClass('inactive');
